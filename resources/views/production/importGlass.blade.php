...
<div class="row">
    ...
    <div class="col-sm-8 col-md-10" id="importGlass">
        <h3 style="margin: 0;">瓶號生產資料庫管理</h3><h6><small>您的IP為{{ request()->ip() }}</small></h6>
        @if (isset($auth))
            <div class="row">
                <div class="">
                    <form class="" id="up" @submit.prevent="submit">
                        <div class="form-group col-lg-5">
                            <input type="file" id="glassFile" name="glassFile" class="form-control" 
...
<script src="{{ url('js/production/importGlass.js?v=1') }}"></script>
@endsection